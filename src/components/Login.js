  ...
  return (
    <div className=" flex items-center justify-center h-screen bg-gradient-to-b from-gray-100 to-gray-500">
      <form className="bg-white shadow-xl rounded p-12 mb-4" onSubmit={handleSubmit}>
        <h2 className="text-2xl font-bold mb-4 text-center">Enter your ID</h2>
        <input type="text" className="border-2 " value={id} onChange={e => setId(e.target.value.toLowerCase())} placeholder="Enter ID" required />
